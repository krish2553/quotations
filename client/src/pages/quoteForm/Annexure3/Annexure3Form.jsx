        ...
        Object.keys(quoteData.annexure3).map((category) => (
          <div key={category} className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-auto border-collapse border border-blue-200/80 rounded-xl">
                <tbody>
                  {quoteData.annexure3[category]?.map((row, rowIndex) => (
                    <tr key={rowIndex} className="even:bg-blue-50/50">
                      {rowIndex === 0 ? (
                        <>
                          <td className="border-b border-blue-200/80 px-4 py-2 font-semibold text-center bg-blue-100">
                            {row[0]}
                          </td>
                          <td className="border-b border-blue-200/80 px-4 py-2 font-semibold text-center bg-blue-100">
                            {row[1]}
                        ...
                        <>
                          <td className="border-b border-blue-200/80 px-4 py-2 text-center">
                            {row[0]}
                          </td>
                          <td className="border-b border-blue-200/80 px-4 py-2">
                            <input
                              type="text"
                              value={row[1]}
                              onChange={(e) =>
                          ...
                          <td className="border-b border-blue-200/80 px-4 py-2 text-center">
                            ...
                            >
                            <FontAwesomeIcon icon={faTrash} className="text-blue-500 hover:text-red-500 cursor-pointer transition-all" />
                            </button>
                          </td>
                        </>
                      )}
