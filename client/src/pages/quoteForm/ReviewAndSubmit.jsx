  ...
  return (
    <div className="p-6 bg-white/60 backdrop-blur-md rounded-2xl shadow space-y-6">
      <button
        ...
        className="px-6 py-2 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-all disabled:opacity-70"
        disabled={loading}
      >
...
{/* 
      ...
      {pdfUrl && (
        <iframe
          ...
          className="w-full h-[80vh] border-2 border-gray-300/80 rounded-xl mt-4"
        />
      )}
    </div>
  );
